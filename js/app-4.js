(function(){
  ...
  const state={parking:null,arinc:null,parkingHttp:"--",arincHttp:"--",parkingSource:"--",arincRoute:"--"};
  ...
  function render(){
    ...
    $("diagParkingSource").textContent=state.parkingSource;$("diagParkingHttp").textContent=state.parkingHttp;$("diagArincRoute").textContent=state.arincRoute;$("diagArincHttp").textContent=state.arincHttp;
    const levels=[parkingLevel,arincLevel,state.parking&&state.arinc?"normal":"offline"];
